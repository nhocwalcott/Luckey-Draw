...
namespace BPVN.LuckyDraw.Utils
{
    ...
    public abstract class SqlHelper {
		...
		public static string ConnectionString { 
			get {
				string dbfile = String.Format(@"{0}data\data.db", AppUtility.GetAppPath());

				if (!File.Exists(dbfile)) {
					throw new ApplicationException("Missing Database.");
				}

				return String.Format("Data Source={0};Pooling=true;Cache Size=102400",dbfile);
			}
		}
